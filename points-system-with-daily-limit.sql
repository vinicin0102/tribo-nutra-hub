...
-- 1. CRIAR TABELA PARA RASTREAR PONTOS DIÁRIOS
...
-- 4. FUNÇÃO: ADICIONAR PONTOS COM LIMITE DIÁRIO
...
-- 5. FUNÇÃO: ADICIONAR PONTOS PARA POST
...
-- 6. FUNÇÃO: ADICIONAR PONTOS PARA CURTIDA (quem curtiu ganha pontos)
...
-- 7. FUNÇÃO: REMOVER PONTOS AO DESFAZER CURTIDA
...
-- 8. FUNÇÃO: ADICIONAR PONTOS PARA COMENTÁRIO
...
-- 9. FUNÇÃO: REMOVER PONTOS AO DELETAR COMENTÁRIO
...
-- 10. FUNÇÃO: ADICIONAR PONTOS PARA LOGIN DIÁRIO
...
-- 11. REMOVER TRIGGERS ANTIGOS
DROP TRIGGER IF EXISTS on_post_created ON public.posts;
DROP TRIGGER IF EXISTS on_like_change ON public.likes;
DROP TRIGGER IF EXISTS on_comment_change ON public.comments;

-- 12. CRIAR NOVOS TRIGGERS
...
-- 13. ATUALIZAR FUNÇÃO DE LOGIN DIÁRIO PARA INCLUIR PONTOS
