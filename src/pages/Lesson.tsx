...
import { ArrowLeft, ArrowRight, ExternalLink, Clock, ChevronDown, ChevronUp, List, CheckCircle2, Circle, FileText, Download, Lock } from 'lucide-react';
...
export default function Lesson() {
  ...
  // Aula bloqueada - mostrar tela especial
  if (!lessonAvailable) {
    return (
      <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center p-4">
        <div className="text-center max-w-md">
          <div className="bg-red-500/20 rounded-full p-6 w-24 h-24 flex items-center justify-center mx-auto mb-6">
            <Lock className="w-12 h-12 text-red-400" />
          </div>
          <h1 className="text-2xl font-bold text-white mb-4">Aula Bloqueada</h1>
          <p className="text-gray-400 mb-2">{lesson.title}</p>

          {daysRemaining === -1 ? (
            <p className="text-amber-400 mb-6">
              Esta aula requer o plano Diamond para ser acessada.
            </p>
          ) : daysRemaining > 0 ? (
            <div className="mb-6">
              <p className="text-gray-300 mb-2">Esta aula será liberada em:</p>
              <div className="bg-amber-500/20 text-amber-400 text-3xl font-bold py-4 px-6 rounded-xl inline-block">
