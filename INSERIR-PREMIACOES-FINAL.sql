-- ============================================
-- INSERIR PREMIAÇÕES - VERSÃO FINAL
-- ============================================
...
DROP POLICY IF EXISTS "Allow all reads" ON public.rewards;
...
-- 5. INSERIR OS 4 PRÊMIOS COM IMAGENS
...
SELECT 
  '✅ PRÊMIOS INSERIDOS COM SUCESSO!' as status,
