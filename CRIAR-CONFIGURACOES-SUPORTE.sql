-- =====================================================
-- CRIAR CONFIGURAÇÕES DE SUPORTE
-- =====================================================
-- Execute este script no Supabase SQL Editor
-- para criar as configurações de horário do chat
-- e mensagem automática
-- =====================================================
...
-- 7. Verificar configurações criadas
SELECT key, value, description FROM public.support_settings ORDER BY key;

-- =====================================================
-- APÓS EXECUTAR, AS CONFIGURAÇÕES ESTARÃO DISPONÍVEIS
-- NO PAINEL ADMIN → ABA "Config"
-- =====================================================
